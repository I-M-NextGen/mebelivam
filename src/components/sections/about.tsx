                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <p className="text-gray-700 leading-relaxed text-lg">
                                    Основател на "МебелиВам" - Ателие за мебели по поръчка (общност) с десетки успешни проекти и доволни клиенти, в което той и екипът му помагат на хората да създадат мечтания си дом, но без успех, да го направят успешно чрез уникални и функционални мебели, които пасват на тяхното пространство.
                                </p>
